      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <span>Solutions</span>
              <svg xmlns="http://www.w3.org/2000/svg" className={`${open ? '' : 'text-opacity-70'}ml-2  text-orange-300 group-hover:text-opacity-80 transition ease-in-out duration-150 h-6 w-6 `} 
              // {`${open ? '' : 'text-opacity-70'}ml-2 h-5 w-5 text-orange-300 group-hover:text-opacity-80 transition ease-in-out duration-150`}
